package com.test.baselibs.constans;
...
public class MyConstans {
    ...
    public static int Screen_Status_Height;//手机状态栏高度
    //传入界面标题名称
    ...
    public static final int Flag_Fragment_Seconde=2;


    public static final String Arout_Path_Activity_Star_For_Result="/test/starForResult";
    public static final String Arout_Path_Activity_User ="/user/main";
}
